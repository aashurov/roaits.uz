...
<table class="product" width="100%" cellpadding="4" cellspacing="0">
  ...
  <tr>
   <!-- <th class="product header small" width="{$layout.reference.width}%">{l s='Reference' d='Shop.Pdf' pdf='true'}</th>-->
    ...
    <th class="product header small" width="220px">{l s='Product' d='Shop.Pdf' pdf='true'}</th>
   <!-- {if $isTaxEnabled}
 ...
 <!--<th class="product header-right small" width="{$layout.unit_price_tax_excl.width}%">-->
    <th class="product header-right small" width="120px">
    ...
    <th class="product header small" width="100px">{l s='Qty' d='Shop.Pdf' pdf='true'}</th>
    <!-- <th class="product header-right small" width="{$layout.total_tax_excl.width}%" style="width: 120px;">-->
    <th class="product header-right small" width="100px">
  ...
  {foreach $order_details as $order_detail}
    ...
    <tr class="product {$bgcolor_class}">
     ...
     <!-- {if $isTaxEnabled}
      ...
      <td class="product right" style="width: 120px;">
      ...
      <td  class="product right" style="width: 100px;">
